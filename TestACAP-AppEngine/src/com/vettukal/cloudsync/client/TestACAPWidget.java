 ...
 *******************************************************************************/
package com.vettukal.cloudsync.client;
...
import com.vettukal.cloudsync.client.MyRequestFactory.HelloWorldRequest;
import com.vettukal.cloudsync.client.MyRequestFactory.MessageRequest;
import com.vettukal.cloudsync.shared.MessageProxy;

public class TestACAPWidget extends Composite {
  ...
  interface TestACAPUiBinder extends UiBinder<Widget, TestACAPWidget> {
  }

  private static TestACAPUiBinder uiBinder = GWT.create(TestACAPUiBinder.class);
