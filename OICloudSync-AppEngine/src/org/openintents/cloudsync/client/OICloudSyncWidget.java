...
import org.openintents.cloudsync.client.MyRequestFactory.MessageRequest;
import org.openintents.cloudsync.shared.MessageProxy;

public class OICloudSyncWidget extends Composite {
  ...
  interface OICloudSyncUiBinder extends UiBinder<Widget, OICloudSyncWidget> {
  }

  private static OICloudSyncUiBinder uiBinder = GWT.create(OICloudSyncUiBinder.class);
