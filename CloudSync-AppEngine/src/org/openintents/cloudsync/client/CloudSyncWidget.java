...
public class CloudSyncWidget extends Composite {
  ...
  interface CloudSyncUiBinder extends UiBinder<Widget, CloudSyncWidget> {
  }

  private static CloudSyncUiBinder uiBinder = GWT.create(CloudSyncUiBinder.class);
